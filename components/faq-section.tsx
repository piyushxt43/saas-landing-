...
const faqs = [
  {
    question: "What is Draftly and how does it work?",
    answer:
      "Draftly is a comprehensive SaaS platform designed to streamline your business operations. Founded by Piyush Singh, it combines project management, team collaboration, analytics, and automation tools in one unified dashboard. Simply sign up, invite your team, and start organizing your workflows with our intuitive interface.",
  },
  {
    question: "Can I try Draftly before committing to a paid plan?",
    answer:
  ...
  {
    question: "How secure is my data with Draftly?",
    answer:
  ...
  {
    question: "Can I integrate Draftly with my existing tools?",
    answer:
      "Yes! Draftly integrates with over 100+ popular tools including Slack, Google Workspace, Microsoft 365, Salesforce, Zapier, and many more. Our API also allows for custom integrations to fit your specific workflow needs.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We offer a 30-day money-back guarantee for all paid plans. If you're not satisfied with Draftly within the first 30 days of your subscription, contact our support team for a full refund.",
  },
  {
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-16">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Everything you need to know about Draftly. Can't find what you're looking for? Contact our support team.
          </motion.p>
        </div>
